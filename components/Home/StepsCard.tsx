      ...
      <div className="grid grid-cols-1 md:grid-cols-4 md:gap-5 gap-3">
        {steps.map((step, index) => (
          ...
          <div className="flex items-center relative top-3 -z-1">
            <p className="text-emerald-300 text-7xl font-extrabold">{step.number}</p>
            ...
            <div
              ...
              className="sm:min-h-[140px] rounded-xl flex p-3 shadow-lg transition-transform duration-300 hover:scale-105 text-white bg-emerald-600/30 border border-emerald-500/70 hover:bg-emerald-600/50 backdrop-blur"
            >
              <div>

...
const Tabs = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:mb-20 mb-10 mt-18">
      {/* Pricing Toggle */}
      <div className="flex justify-center mb-12">
        <div className="inline-flex items-center p-1 rounded-[16px] border border-emerald-300 text-[#FDFDFD]">
          <button
            onClick={() => setIsYearly(false)}
            className={`px-6 py-4 rounded-[16px] text-sm font-medium transition-all duration-200 ${
